	...
	<div class="container-fluid">
		<div class="row bg-title">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h4 class="page-title"><a href="${ctx}/sys/office/list?id=${office.parent.id}&parentIds=${office.parentIds}"><i class="mdi mdi-arrow-left-bold"></i>机构列表</a></h4>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
					...
					<div class="panel-wrapper collapse in" aria-expanded="true">
						<div class="panel-body">
							<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label"><span class="help-inline"><font color="red">*</font> </span>机构名称:</label>
									<div class="col-sm-5">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<form:select path="type" class="input-medium" cssClass="form-control selectpicker" data-style="form-control">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<form:select path="grade" class="input-medium" cssClass="form-control selectpicker" data-style="form-control">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<form:select path="useable" cssClass="form-control selectpicker" data-style="form-control">
											<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
										</form:select>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">主负责人:</label>
									<div class="col-sm-5">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">副负责人:</label>
									<div class="col-sm-5">
								...
								<c:if test="${empty office.id}">
									<div class="form-group">
										<label class="col-sm-4 control-label">快速添加下级部门:</label>
