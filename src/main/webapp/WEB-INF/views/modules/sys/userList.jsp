                ...
                <div class="panel-body">
                    <form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/list" method="post" class="form-search">
                        ...
                        <div class="form-actions" style="float: right">
                            <button class="btn btn-primary btn-sm" type="submit" onclick="return page();"> <i class="fa fa-search"></i> <span>查询</span></button>
                ...
                <div class="panel-body">
                    <div style="float: left;margin-bottom: 20px;">
                        <shiro:hasPermission name="sys:user:edit">
                            <a href="${ctx}/sys/user/form" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> 新增</a>
                        </shiro:hasPermission>
                        <button id="btnExport" class="btn btn-googleplus btn-sm" type="button">导出</button>
                        <button id="btnImport" class="btn btn-warning btn-sm" type="button">导入</button>
                    </div>
                    <sys:message content="${message}"/>
                    <div class="row">
