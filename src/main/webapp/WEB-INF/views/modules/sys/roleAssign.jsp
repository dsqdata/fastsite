	...
	<div class="container-fluid">
		<div class="row bg-title">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h4 class="page-title"><a href="${ctx}/sys/role/"><i class="mdi mdi-arrow-left-bold"></i>角色列表</a></h4>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
						...
						<div class="panel-body">
							<div class="container-fluid breadcrumb">
								<div class="row">
									...
									<span class="col-md-4">归属机构: <b>${role.office.name}</b></span>
									<span class="col-md-4">英文名称: <b>${role.enname}</b></span>
								</div>
								<div class="row">
									<span class="col-md-4">角色类型: <b>${role.roleType}</b></span>
									<c:set var="dictvalue" value="${role.dataScope}" scope="page" />
									<span class="col-md-4">数据范围: <b>${fns:getDictLabel(dictvalue, 'sys_data_scope', '')}</b></span>
								</div>
							</div>
