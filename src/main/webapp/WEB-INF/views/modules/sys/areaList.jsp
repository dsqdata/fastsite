									...
									<script type="text/template" id="treeTableTpl">
										<tr id="{{row.id}}" pId="{{pid}}">
											...
											<shiro:hasPermission name="sys:area:edit"><td>
												<a href="${ctx}/sys/area/form?id={{row.id}}" style="color: green;">修改 &nbsp;&nbsp;</a>
												<a href="${ctx}/sys/area/delete?id={{row.id}}" onclick="return confirmx('要删除该区域及所有子区域项吗？', this.href)" style="color: red;">删除 &nbsp;&nbsp;</a>
												<a href="${ctx}/sys/area/form?parent.id={{row.id}}" style="color: #0b0b0b;">添加下级区域 &nbsp;&nbsp;</a>
