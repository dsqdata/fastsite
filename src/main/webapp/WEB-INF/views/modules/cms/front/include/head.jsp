...
<meta name="author" content="http://Fastsite.iteye.com"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
...
<c:if test="${site.theme eq 'basic'}">
	...
	<link href="${ctxStatic}/common/fastsite.min.css" type="text/css" rel="stylesheet" />
