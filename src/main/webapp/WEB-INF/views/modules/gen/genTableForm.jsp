    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title"><a href="${ctx}/gen/genTable/"><i class="mdi mdi-arrow-left-bold"></i>返回</a></h4>
            </div>
                            ...
                            <c:choose>
                                <c:when test="${empty genTable.name}">
                                    <form:form id="inputForm" modelAttribute="genTable"
                                               action="${ctx}/gen/genTable/form" method="post" class="form-horizontal">
                                        <form:hidden path="id"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <form:select path="name" class="input-xxlarge  selectpicker"
                                ...
                                <c:otherwise>
                                    <form:form id="inputForm" modelAttribute="genTable"
                                               action="${ctx}/gen/genTable/save" method="post" class="form-horizontal">
                                        <form:hidden path="id"/>
                                        <sys:message content="${message}"/>
                                        <fieldset>
                                            <legend>基本信息</legend>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <form:select path="parentTable" cssClass="input-xlarge form-control selectpicker" data-style="form-control">
                                                        <form:option value="">无</form:option>
                                                        <form:options items="${tableList}" itemLabel="nameAndComments" itemValue="name" htmlEscape="false"/>
                                                    </form:select>
                                                    &nbsp;当前表外键：
                                                    <form:select path="parentTableFk" cssClass="input-xlarge form-control selectpicker" data-style="form-control">
                                                        <form:option value="">无</form:option>
                                            ...
                                            <div class="form-group" style="overflow-x:auto;">
                                                <table id="contentTable"
                                                       class="table table-striped table-bordered table-condensed" style="overflow-x:auto;">
                                                    <thead>
                                                    <tr>
                                                        ...
                                                        <tr${column.delFlag eq '1'?' class="error" title="已删除的列，保存之后消失！"':''}>
                                                            <td nowrap>
                                                                <input type="hidden" name="columnList[${vs.index}].id"
                                                                       value="${column.id}"/>
                                                                <input type="hidden"
                                                                       name="columnList[${vs.index}].delFlag"
                                                            ...
                                                            <td>
                                                                <select name="columnList[${vs.index}].javaType"
                                                                    ...
                                                                    <c:forEach items="${config.javaTypeList}"
                                                                               var="dict">
                                                            ...
                                                            <td>
                                                                <select name="columnList[${vs.index}].queryType"
                                                                        class="required input-mini">
                                                                    <c:forEach items="${config.queryTypeList}"
                                                                               var="dict">
                                                            ...
                                                            <td>
                                                                <select name="columnList[${vs.index}].showType"
                                                                        class="required" style="width:100px;">
                                                                    <c:forEach items="${config.showTypeList}"
                                                                               var="dict">
