...
<section id="wrapper" class="error-page">
	<div class="error-box">
		<div class="error-body text-center">
			<h1>500</h1>
			<h3 class="text-uppercase">系统内部错误.</h3>
			<p class="text-muted m-t-30 m-b-30">错误信息：<%=ex==null?"未知错误.":StringUtils.toHtml(ex.getMessage())%> </p>
			<p class="text-muted m-t-30 m-b-30">请复制“查看详细信息”按钮，将详细错误信息发送给系统管理员，谢谢！<br/> <br/></p>
