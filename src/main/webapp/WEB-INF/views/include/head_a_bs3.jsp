...
<meta name="author" content="http://fastsite.com/"/>
...
<script type="text/javascript">
    var ctx = '${ctx}', ctxPath = '/${ctx}', ctxStatic = '${ctxStatic}', ctxAdmin = '${ctx}';
    var js = {
        startWith: function (str, start) { var reg = new RegExp("^" + start); return reg.test(str) },
        error: function (msg) { if (typeof (console) !== "undefined") { console.error(msg) } }
    }
</script>
